...
def clean_and_filter_data(df):
    ...
    schema_columns = [col.name for col in CrewCarbonLabReadings.__table__.columns if col.name != 'id']
...
if __name__ == "__main__":
    ...
    print(f"✓ Successfully wrote all data to crew_carbon_lab_readings")
