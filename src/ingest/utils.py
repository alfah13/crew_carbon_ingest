...
def transform_crew_data(
    ...
    if drop_duplicates:
        logger.info("[Step 0/5] Removing duplicate rows")
        ...
        logger.info("[Step 0/5] Removing duplicate rows - SKIPPED")
    
    # Step 1: Select columns
    logger.info("[Step 1/5] Selecting columns")
    ...
    if column_dtype_mapper:
        logger.info("[Step 2/5] Casting data types")
        ...
        logger.info("[Step 2/5] Casting data types - SKIPPED")
    
    # Step 3: Rename columns
    if columns_rename_mapper:
        logger.info("[Step 3/5] Renaming columns")
        ...
        logger.info("[Step 3/5] Renaming columns - SKIPPED")
    
    # Step 4: Create metadata
    logger.info("[Step 4/5] Creating metadata column")
    ...
    logger.info("[Step 5/5] Transformation complete")
